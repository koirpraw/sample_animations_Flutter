...
class ProgressStateButtonPage extends StatefulWidget {

  @override
  _ProgressStateButtonPageState createState() => _ProgressStateButtonPageState();
}

class _ProgressStateButtonPageState extends State<ProgressStateButtonPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Progress State Button"),
      ),
      body: Center(
        child: Column(
